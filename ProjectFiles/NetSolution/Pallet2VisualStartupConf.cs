...
public class Pallet2VisualStartupConf : BaseNetLogic
{
    ...
    public void replaceSVG()
    {
        ...
        AdvancedSVGImage svgImage = LogicObject.Owner.Get<AdvancedSVGImage>("SVGPallet2Startup");

        // Retrieve parameters
        var paramObj = LogicObject.Owner.GetObject("Pallet2VisualizationParametersStartup");
