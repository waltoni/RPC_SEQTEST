...
public class Pallet4VisualStartupConf : BaseNetLogic
{
    ...
    public void replaceSVG()
    {
        ...
        AdvancedSVGImage svgImage = LogicObject.Owner.Get<AdvancedSVGImage>("SVGPallet4Startup");

        // Retrieve parameters
        var paramObj = LogicObject.Owner.GetObject("Pallet4VisualizationParametersStartup");
