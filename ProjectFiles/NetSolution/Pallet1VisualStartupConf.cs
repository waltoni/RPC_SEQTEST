...
public class Pallet1VisualStartupConf : BaseNetLogic
{
    ...
    public void replaceSVG()
    {
        ...
        AdvancedSVGImage svgImage = LogicObject.Owner.Get<AdvancedSVGImage>("SVGPallet1Startup");

        // Retrieve parameters
        var paramObj = LogicObject.Owner.GetObject("Pallet1VisualizationParametersStartup");
    ...
    private float FlipY(float originalY, float rotation, float productWidth, float productLength, int overhangWidth, float canvasWidth)
    {
        ...
        return (canvasWidth - originalY - unitLength - (overhangWidth > 0 ? overhangWidth * 2 : 0));
    }
}
